...
public class Room 
{
    ...
    /**
     * Removes and returns an Item object to be picked up from take command if
     * it the item is within the room. 
     * 
     * @param itemToTake String of the item that should be picked up.
     * @return The item that is picked up, returns null if item does not exist
     */
    public Item pickupItem(String itemToTake) 
    {
        for (Item item: items) {
    ...
    /**
     * Return an ArrayList of all the rooms in the adventure game.
     * 
